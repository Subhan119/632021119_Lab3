  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        body: ListView(
          children: [
            Image.asset('image/omlet_cover.jpg'),
          ...
          const Text('แจกสูตรอาหารเช้าง่าย ๆ "ออมเลตชีส" เมนูไข่ของโปรดทุกรุ่นทุกวัย เนื้อไข่นุ่มมมละมุนลิ้น แถมชีสเยิ้ม ๆ ยั่วใจ ทำตามกันได้ที่บ้านเลย ขนาดนี้ต้องลองทำแล้ว'),
           CircleAvatar(
            ...
            backgroundImage: NetworkImage(
              'https://scontent.fbkk10-1.fna.fbcdn.net/v/t39.30808-6/296914845_886619678964534_6533097786599982487_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=8mQGy9Qyu94AX_hPMUl&tn=BG-Xc8WclqNRiHb7&_nc_ht=scontent.fbkk10-1.fna&oh=00_AfBbUjMbH3AQ75vv86tewTD_ZOyHwWfcStmlXWZSXnI_4A&oe=639FCC03'
            )
           ),
           const Text('วันที่ 17 ธ.ค. 2546 โดย เชฟฮาน'),
